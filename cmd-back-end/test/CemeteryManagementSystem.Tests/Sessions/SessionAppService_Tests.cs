using CemeteryManagementSystem.Sessions;
using Shouldly;
using System.Threading.Tasks;
using Xunit;

namespace CemeteryManagementSystem.Tests.Sessions;

public class SessionAppService_Tests : CemeteryManagementSystemTestBase
{
