...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = CemeteryManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(CemeteryManagementSystemDbContext context)
    {
        _context = context;
    }
