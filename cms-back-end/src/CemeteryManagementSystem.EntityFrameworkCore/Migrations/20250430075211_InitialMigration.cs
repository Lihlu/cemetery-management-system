        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PublicUsers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplexOrEstateAddress = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_PublicUsers_PublicUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_PublicUserId",
                table: "Addresses",
                column: "PublicUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PublicUsers_UserId",
                table: "PublicUsers",
                column: "UserId");
        }
